...
export const registerEmployee = async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      <a href="http://localhost:3000/pages/employeeemailverification/${verificationCode}">Verify</a>
    `,
    };
  ...
  try {
    ...
    const mailOptions = {
      ...
      html: `
          ...
          <a href="http://localhost:3000/pages/employeeresetpassword/${user._id}/${token}">Reset</a>
        `,
    };
