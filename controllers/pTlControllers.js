...
export const PgetTeamFormAllData = async (req, res) => {
  try {
    let query = {};
    ...
    const userData = await PFormalData.find({ TL_Name, ...query });
...
export const PfetchTLPendingData = async (req, res) => {
  try {
    let query = {};
    ...
    if (Status) {
      userData = await PPendingFormData.find({ TL_Name, Status, ...query });
    } else {
      userData = await PPendingFormData.find({ TL_Name, ...query });
    }
...
export const PfetchTlDisbursedData = async (req, res) => {
  try {
    let query = {};
    ...
    if (Status) {
      userData = await PDisbursedData.find({ TL_Name, Status, ...query });
    } else {
      userData = await PDisbursedData.find({ TL_Name, ...query });
    }
...
export const PfetchTlRejectedData = async (req, res) => {
  try {
    let query = {};
    ...
    if (Status) {
      userData = await PRejectedData.find({ TL_Name, Status, ...query });
    } else {
      userData = await PRejectedData.find({ TL_Name, ...query });
    }
...
export const PdeleteDisbursedData = async (req, res) => {
  const id = req.params.id;
  try {
    // Perform deletion in your database using the provided ID
...
export const PdeleteRejectedData = async (req, res) => {
  const id = req.params.id;
  try {
    // Perform deletion in your database using the provided ID
